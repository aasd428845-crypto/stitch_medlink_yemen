...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get digitalCardInstruction => 'اعرض هذا الرمز للتحقق من بطاقتك الرقمية';
  ...
  @override
  String get businessProfileNote => 'تُدار بيانات الحساب الأساسية من خلال الملف المسجل في النظام.';
  ...
  @override
  String get termsSectionBody => 'باستخدام MedLink، تؤكد صحة بياناتك وتتعهد باستخدام التطبيق لطلب الأدوية والمنتجات الطبية بطريقة نظامية. تخضع الطلبات للتوفر والمراجعة والتوصيل حسب الفرع.';

  @override
  String get privacySectionTitle => 'الخصوصية';

  @override
  String get privacySectionBody => 'نستخدم بيانات الحساب والعناوين والطلبات لتشغيل الخدمة وتوصيل الطلبات وتحسين الدعم. لا يعرض التطبيق بياناتك لعملاء آخرين، وتخضع البيانات لسياسات قاعدة البيانات وصلاحيات الحساب.';
  ...
  @override
  String get noReorderRecommendations => 'ستظهر اقتراحات إعادة الطلب بعد توفر سجل شراء كافٍ';
  ...
  @override
  String get specialRequestSubtitle => 'اطلب دواءً أو منتجاً غير متوفر حالياً في الكتالوج';
  ...
  @override
  String get driverHeroSubtitle => 'تابع مهام التوصيل وحالة الطلبات من شاشة واحدة.';
  ...
  @override
  String get reorderAddedToCart => 'تمت إعادة إضافة الأصناف إلى السلة بالأسعار الحالية';
