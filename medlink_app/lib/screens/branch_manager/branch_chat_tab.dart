    ...
    return ListView(
      ...
      children: [
        const BranchManagerHero(
          title: 'المحادثات',
          subtitle: 'تواصل سريع مع السائقين لمتابعة الطلبات والتوصيلات.',
        ),
                ...
                child: Row(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: BranchColors.primary.withValues(alpha: .12),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '#${room.orderId.substring(0, 8).toUpperCase()}',
                        ...
                        Text(
                          room.driverName ?? l10n.chatWithDriver,
                          style: const TextStyle(
